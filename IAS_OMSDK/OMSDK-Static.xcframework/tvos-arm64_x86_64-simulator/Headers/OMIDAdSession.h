 ...
 */
@property(nonatomic, readonly) OMIDAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDAdSessionContext *)context
